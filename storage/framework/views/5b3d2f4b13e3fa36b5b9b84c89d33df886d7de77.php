    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            <div class="ibox-tools m-t-xl">
                <a href="<?php echo e(route('parents.create')); ?>" class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><i class="fa fa-plus"></i> <strong>Create</strong></a>
            </div>
        </div>
    </div>
                                ...
                                <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a title="Edit" href="<?php echo e(route('parents.edit', $item->id)); ?>" class="cus_mini_icon color-success"> <i class="fa fa-pencil-square-o"></i></a>
                                        ...
                                        <form id="class-delete-form<?php echo e($item->id); ?>" method="POST" action="<?php echo e(route('parents.destroy', $item->id)); ?>" style="display: none" >
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\student-management-system1\resources\views/parent/index.blade.php ENDPATH**/ ?>